...
const assessment_1 = __importDefault(require("./routes/api/assessment"));
const grade_1 = __importDefault(require("./routes/api/grade"));
...
app.use("/api/grades", grade_1.default);
